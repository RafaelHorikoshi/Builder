...
public class PacienteBuilder {
    ...
    public PacienteBuilder doTipoSanguineo(String tipoSanguineo)
    {
        dadosFisicos.setTipoSanguineo(tipoSanguineo);
        return this;
    }
    
    public PacienteBuilder doCep(String cep)
    {
        endereco.setCep(cep);
        return this;
    }
    
    public PacienteBuilder doLogradouro(String logradouro)
    {
        endereco.setLogradouro(logradouro);
        return this;
    }
    
    public PacienteBuilder doNumero(int numero)
    {
        endereco.setNumero(numero);
        return this;
    }
    
    public PacienteBuilder daCidade (String cidade)
    {
        endereco.setCidade(cidade);
        return this;
    }
    
    public PacienteBuilder doUf (String Uf)
    {
        endereco.setUf(Uf);
        return this;
    }
    public PacienteBuilder Doador(boolean doador)
    {
        paciente.setDoadorDeOrgaos(doador);
        return this;
    }
    public PacienteBuilder comCodigo(int codigo)
    {
